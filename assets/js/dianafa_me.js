...
var diana = (function ($) {
    ...
    var indexPostClass = '.diana-index-post',
        mobileMenuButton = '.diana-mobile-menu a',
        mobileMenuCloseButton = '.diana-mobile-close-btn',
        mainMenu = '.diana-menu',
        bgCheckClass = '.bg-check',
        postBgImages = '.bg-img img',
        postCoverImg = '.diana-post-header .bg-img',
    ...
    // diana javascripts initialization
    init = function () {
        indexPostAnimate();
